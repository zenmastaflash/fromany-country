    ...
    <div className="p-8 space-y-8">
      ...
      <Card className="relative overflow-hidden h-[80vh] bg-secondary">
        ...
        <div className="absolute w-full h-full">
          {/* Largest to smallest, secondary -> accent */}
          <div className="circle circle-5 bg-secondary" />
          <div className="circle circle-4 bg-secondary/90" />
          <div className="circle circle-3 bg-accent/60" />
          <div className="circle circle-2 bg-accent/80" />
